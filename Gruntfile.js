...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        wiredep: {
            app: {
                ...
                //,
                //ignorePath: /\.\.\/webapp\/bower_components\// // remove
                // ../webapp/bower_components/ from paths of injected sass files
            },
            test: {
        ...
        cdn: {
            ...
            dist: {
                ...
                dest: './src/main/resources/templates_dist/',
                /** @required  - files to process */
                src: [
                    './src/main/resources/templates_dist/*.html'
                ],
            }
        },
        browserSync: {
            ...
            dist: {
                files: [{
                    ...
                    src: [
                        '.tmp',
                        '<%= yeoman.dist %>/*',
                        'src/main/resources/templates_dist/*',
                        '!<%= yeoman.dist %>/.git*'
                    ]
                }]
            },
            ...
            options: {
                ...
                flow: {
                    html: {
                        steps: {
                            js: ['concat', 'uglifyjs'],
                            css: ['cssmin', useminAutoprefixer] // Let cssmin concat files so it
                                                                // corrects relative paths to fonts
                                                                // and images
                        },
                        post: {}
                    }
        ...
        imagemin: {
            dist: {
                files: [{
                    ...
                    src: '**/*.{jpg,jpeg}', // we don't optimize PNG files as it doesn't work on
                                            // Linux. If you are not on Linux, feel free to use
                                            // '**/*.{png,jpg,jpeg}'
        ...
        htmlmin: {
            dist: {
                ...
                files: [{
                    ...
                    expand: true,
                    cwd: 'src/main/resources/templates_dist',
                    src: ['*.html', '**/*.html'],
                    dest: 'src/main/resources/templates_dist'
                }]
            }
    ...
    grunt.registerTask('appendSkipBower', 'Force skip of bower for Gradle',
                       function () {
