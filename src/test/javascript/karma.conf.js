...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'main/webapp/bower_components/jquery-tokeninput/src/jquery.tokeninput.js',
            'main/webapp/bower_components/angular-tour/dist/angular-tour-tpls.min.js',
            'main/webapp/bower_components/marked/lib/marked.js',
            'main/webapp/bower_components/angular-marked/dist/angular-marked.js',
            'main/webapp/bower_components/simple-module/lib/module.js',
            'main/webapp/bower_components/simple-hotkeys/lib/hotkeys.js',
            'main/webapp/bower_components/simple-uploader/lib/uploader.js',
            'main/webapp/bower_components/simditor/lib/simditor.js',
            'main/webapp/bower_components/to-markdown/dist/to-markdown.js',
            'main/webapp/bower_components/simditor-markdown/lib/simditor-markdown.js',
