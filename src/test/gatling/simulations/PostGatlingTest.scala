...
class PostGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Post entity")
        ...
        .repeat(2) {
            ...
            .post("/api/posts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "url":"SAMPLE_TEXT", "domain":"SAMPLE_TEXT", "author":"SAMPLE_TEXT", "summary":"SAMPLE_TEXT", "content":"SAMPLE_TEXT", "status":null}""")).asJSON
            .check(status.is(201))
