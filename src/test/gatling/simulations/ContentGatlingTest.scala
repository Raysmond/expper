...
class ContentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Content entity")
        ...
        .repeat(2) {
            ...
            .post("/api/contents")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "content":"SAMPLE_TEXT", "summary":"SAMPLE_TEXT", "status":null, "permalink":"SAMPLE_TEXT", "createdAt":"2020-01-01T00:00:00.000Z", "updatedAt":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
